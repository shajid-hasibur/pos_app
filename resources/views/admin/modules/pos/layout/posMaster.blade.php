...
<head>
 ...
 <style>
  ...
  .go>.row>.col-4>.d_class>.d_class1>.bill-p, .go>.row>.col-4>.d_class>.d_class2>.bill-p{
    margin-bottom: 0px;
    font-size:20px;
    font-weight: 500;
  }
  ...
  .go>.row>.col-4>div>table>thead>tr>th, .go>.row>.col-4>div>table>tbody>tr>td{
    font-size:18px;
  }
  ...
  <span class="navbar-text">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link" href="#" data-toggle="dropdown" id="user-profile">
        ...
        @else
        <img src="{{asset('admin/defaultIcon/user.png')}}" style="height: 30px; width:30px;">
        @endif
      </a>
