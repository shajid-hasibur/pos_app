			...
			<ul class="navbar-nav mr-auto ">
                ...
                <li class="nav-item dropdown ">
					...
					<ul class="dropdown-menu p-0" id="dropdown-background">
						...
						<li>
							<a href="{{route('admin.product.promotionlist')}}" class="dropdown-item" href="">Promotion List</a>
						</li>

						<li>
							<a href="{{route('admin.product.promoCode')}}" class="dropdown-item" href="">Add Promo Code</a>
						</li>

						<li>
							<a href="{{route('admin.product.promoCodelist')}}" class="dropdown-item" href="">Promo Code List</a>
						</li>
					</ul>
				</li>
				<li class="nav-item dropdown">
				...
				<li class="nav-item dropdown ">
					...
					<ul class="dropdown-menu p-0" id="dropdown-background">
						...
						<li>
							<a href="{{route('admin.attendence')}}" class="dropdown-item" href="">Attendence</a>
						</li>
						<li>
							<a href="{{route('admin.attendenceData')}}" class="dropdown-item" href="">Attendence data</a>
						</li>
					</ul>
				</li>
